                    ...
                    <div style="width: 100%" class="uk-width-1-1 uk-margin-remove uk-padding-remove uk-position-center uk-overlay">
                        <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                            <div class="uk-width-1-2 uk-padding-remove uk-margin-remove">
                                ...
                                <h3 class="open-sans-semi-bold uk-padding-remove uk-margin-small-top uk-margin-medium-bottom">Masuk ke Panel Admin</h3>
                                <form class="uk-width-1-1 uk-form-stacked uk-padding-remove uk-margin-remove" method="POST" action="<?php echo base_url(); ?>admin_panel/login/aksi_login">
