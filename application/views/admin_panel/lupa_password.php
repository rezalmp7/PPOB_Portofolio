    ...
    <div class="uk-container uk-container-expand uk-margin-remove uk-padding-remove" id="user-login">
        <div style="min-height: 100vh;" class="uk-width-1-1 uk-padding-remove uk-margin-remove" uk-grid>
            ...
            <div class="form-login uk-width-3-5@s uk-padding-remove uk-margin-remove">
                ...
                <div class="uk-width-1-1 uk-padding-small uk-margin-remove uk-text-right"><a class="uk-button uk-button-text" href="<?php echo base_url(); ?>admin_panel/login">Login</a></div>
                    <div style="width: 100%" class="uk-width-1-1 uk-margin-remove uk-padding-remove uk-position-center uk-overlay">
                        <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                            <div class="uk-width-1-2@l uk-width-5-6 uk-padding-remove uk-margin-remove">
                                <img style="height: 50px" src="<?php echo base_url(); ?>assets/img/website/logo_1.png">
                                <h3 class="open-sans-semi-bold uk-padding-remove uk-margin-small-top uk-margin-medium-bottom">Lupa Password</h3>
                                <form class="uk-width-1-1 uk-form-stacked uk-padding-remove uk-margin-remove" method="POST" action="<?php echo base_url(); ?>admin_panel/login/kirim_kode">
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-text">Email Akun</label>
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: user"></span>
                                            <input class="uk-input" type="text" name="email" placeholder="Email yang terdaftar">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-form-controls">
                                            <input type="submit" value="Kirim Link" class="uk-button uk-button-primary uk-border-rounded">
                                        </div>
                                    </div>
                                </form>
                            </div>
