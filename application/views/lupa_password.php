                    ...
                    <div style="width: 100%" class="uk-width-1-1 uk-margin-remove uk-padding-remove uk-position-center uk-overlay">
                        <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                            <div class="uk-width-1-2@l uk-width-5-6 uk-padding-remove uk-margin-remove">
                                ...
                                <form class="uk-width-1-1 uk-form-stacked uk-padding-remove uk-margin-remove" method="POST" action="<?php echo base_url(); ?>login/kirim_kode">
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-text">Username Akun</label>
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: user"></span>
                                            <input class="uk-input" type="text" name="username" placeholder="Username yang terdaftar">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
