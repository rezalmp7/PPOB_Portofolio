            ...
            <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                <div class="uk-width-5-6@s">
                    ...
                    <div class="uk-width-1-1 uk-padding-remove uk-margin-medium-top uk-margin-remove-left uk-margin-remove-right" uk-grid>
                            ...
                            <table class="uk-table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if($type != "produk_spesial")
                                                {
                                                    echo $detail_produk->product_name; 
                                                }
                                                else {
                                                    echo $detail_produk->nama;
                                                }
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Rp 
                                            ...
                                            if($type != "produk_spesial")
                                            {
                                                echo number_format($detail_produk->price,0,',','.'); 
                                            }
                                            else {
                                                echo number_format($detail_produk->harga,0,',','.');
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp 
                                            <?php 
                                                echo number_format($detail_produk->diskon,0,',','.');
                                            ?>
                                        </td>
                                    </tr>
                                    <?php
                                    $total_harga_spesial = $detail_produk->harga-$detail_produk->diskon;
                                    $total_harga = $total_harga_spesial+$harga['keuntungan'];
                                    ?>
                                    <tr>
                                        <th>Total Harga</th>
                                        <td>Rp <?php echo number_format($total_harga_spesial,0,',','.'); ?></td>
                                    </tr>
                                    <?php
                                    }
                                    else {
                                        $total_harga = $detail_produk->price+$harga['keuntungan'];
                                    }
                                    ?>
                                    <tr>
                                        <th>Admin</th>
                                        <td>Rp <?php echo number_format($harga['keuntungan'],0,',','.'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Total Harga</th>
                        ...
                        <div class="uk-width-1-2@s uk-padding-small uk-margin-remove">
                            <form class="uk-form-stacked" method="POST" action="<?php echo base_url(); ?>user_panel/transaksi/transaksi_produk_spesial">
                                <div class="uk-width-1-1 uk-box-shadow-medium uk-padding-small uk-background-primary uk-margin-remove uk-border-rounded">
                                    <div class="uk-padding-small uk-background-muted uk-border-rounded uk-width-1-1 uk-margin" onClick="bayar_dengan_coin()">
                                        <label><input class="uk-checkbox" name="coin" value="1" type="checkbox" id="cek_bayar_coin" <?php if($pengguna['coin'] <= 0) echo "disabled"; ?>> Gunakan Coin (<?php echo $pengguna['coin']; ?>)</label>
                                    </div>
                                    <!-- tanpa coin -->
                                    <div class="uk-width-1-1 uk-padding-remove uk-margin-remove" id="tanpa_coin">
                                        ...
                                        <div class="color-black uk-width-1-1 uk-padding-remove uk-margin-remove" uk-grid>
                                            <div class="uk-width-auto uk-padding-remove uk-margin-remove"><?php if($type != 'produk_spesial') echo $detail_produk->product_name; else echo $detail_produk->nama; ?></div>
                                            <div class="uk-width-expand uk-padding-remove uk-margin-remove uk-text-right">
                                                Rp 
                                                <?php 
                                                if($type != "produk_spesial")
                                                {
                                                    ...
                                                    echo number_format($total_harga_spesial,0,',','.');
                                                }
                                                ?>
                                            </div>
                                        </div>
                                        <div class="color-black uk-width-1-1 uk-padding-remove uk-margin-remove" uk-grid>
                                            <div class="uk-width-auto uk-padding-remove uk-margin-remove">Admin</div>
                                            <div class="uk-width-expand uk-padding-remove uk-margin-remove uk-text-right">Rp <?php echo number_format($harga['keuntungan'],0,',','.'); ?></div>
                                        </div>
                                        ...
                                        <div class="color-black uk-width-1-1 uk-padding-remove uk-margin-remove" uk-grid>
                                            ...
                                            <div class="uk-width-expand uk-padding-remove uk-margin-remove uk-text-right" id="harga">Rp <?php echo number_format($total_harga,0,',','.'); ?></div>
                                        </div>
                                        <?php
                                        $sisa_saldo = $pengguna['saldo']-(int)$total_harga;
                                        $bayar_saldo = $total_harga;
                                        $bayar_coin = 0;
                                        ?>
                                    ...
                                    <div class="uk-width-1-1 uk-margin-remove uk-padding-remove" id="dengan_coin">
                                        ...
                                        <?php
                                        if($pengguna['coin'] <= $total_harga)
                                        {
                                            $min_coin = $pengguna['coin'];
                                            $sisa_coin = 0;
                                            $sisa_harga = $total_harga-$pengguna['coin'];
                                        }
                                        else {
                                            $min_coin = $total_harga;
                                            $sisa_coin = $pengguna['coin']-$total_harga;
                                            $sisa_harga = 0;
                                        }
                                ...
                                ?>
                                <input type="hidden" name="produk" value="<?php if($type != 'produk_spesial') echo $detail_produk->code; else echo $detail_produk->nama; ?>">
                                <input type="hidden" name="nomor" value="<?php echo $transaksi['nomor']; ?>">
                                <input type="hidden" name="harga_vip" value="<?php echo $total_harga; ?>">
