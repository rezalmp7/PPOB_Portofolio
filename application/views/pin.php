                ...
                <div class="uk-width-1-1 uk-padding-small uk-margin-remove uk-text-right"><a class="uk-button uk-button-text" href="<?php echo base_url(); ?>login">Login</a></div>
                    <div style="width: 100%" class="uk-width-1-1 uk-margin-remove uk-padding-remove uk-position-center uk-overlay">
                        <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                            <div class="uk-width-1-2@m uk-width-5-6 uk-padding-remove uk-margin-remove">
                                <img style="height: 50px" src="<?php echo base_url(); ?>assets/img/website/logo_1.png">
                                <h3 class="open-sans-semi-bold uk-padding-remove uk-margin-small-top uk-margin-medium-bottom">Masukan PIN anda</h3>
                                <form class="uk-width-1-1 uk-form-stacked uk-padding-remove uk-margin-remove" method="POST" action="<?php echo base_url(); ?>login/pin_aksi">
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-inline uk-width-1-1">
                                            ...
                                            <input class="uk-input field-default" id="myInput" type="password" name="pin" minlength="6" maxlength="6" placeholder="PIN...">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-form-controls">
                                            <input type="submit" value="Login" class="uk-button uk-button-primary uk-border-rounded">
                                        </div>
                                    </div>
                                </form>
                            </div>
