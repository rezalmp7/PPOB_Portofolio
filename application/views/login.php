...
<body>
    <div class="uk-container uk-container-expand uk-margin-remove uk-padding-remove" id="user-login">
        <div style="min-height: 100vh;" class="uk-width-1-1 uk-padding-remove uk-margin-remove" uk-grid>
            <div class="uk-visible@s content uk-background-primary uk-grid-match uk-width-2-5 uk-padding-remove uk-margin-remove uk-clearfix">
                <div class="uk-height-1-1 uk-width-1-1 uk-inline">
                    <?php
                    $session_flashdata_error = $this->session->flashdata('error');
                    if($session_flashdata_error != null)
                    {
                    ?>
                    <script>
                        UIkit.modal.alert('<?php echo $this->session->flashdata('error'); ?>');
                    </script>
                    <?php
            ...
            <div class="form-login uk-width-3-5@s uk-padding-remove uk-margin-remove">
                <div class="uk-height-1-1 uk-width-1-1 uk-inline uk-padding-remove uk-margin-remove uk-clearfix">
                    <div class="uk-width-1-1 uk-padding-small uk-margin-remove uk-text-right">Belum punya akun? <a class="uk-button uk-button-text" href="<?php echo base_url(); ?>daftar">Daftar sekarang</a></div>
                    <div style="width: 100%" class="uk-width-1-1 uk-margin-remove uk-padding-remove uk-position-center uk-overlay">
                        <div class="uk-width-1-1 uk-padding-remove uk-margin-remove uk-flex-center" uk-grid>
                            <div class="uk-width-1-2@m uk-padding-small uk-margin-remove">
                                <img style="height: 50px" src="<?php echo base_url(); ?>assets/img/website/logo_1.png">
                                <h3 class="open-sans-semi-bold uk-padding-remove uk-margin-small-top uk-margin-medium-bottom">Masuk ke PPOB</h3>
                                <form class="uk-width-1-1 uk-form-stacked uk-padding-remove uk-margin-remove" method="POST" action="<?php echo base_url(); ?>login/aksi_login">
                                    ...
                                    <div class="uk-grid-small" uk-grid>
                                        <div class="uk-width-1-2@s">
                                            <label><input class="uk-checkbox" type="checkbox" name="remember" value="1"> Selalu masuk</label>
                                        </div>
                                        <div class="uk-width-1-2@s uk-text-right">
                                            <a href="<?php echo base_url(); ?>login/lupa_password" class="uk-button uk-button-text">Lupa Kata Sandi?</a>
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-form-controls">
                                            <input type="submit" value="Masuk" class="uk-button uk-button-primary uk-border-rounded">
                                        </div>
                                    </div>
                                </form>
                            </div>
